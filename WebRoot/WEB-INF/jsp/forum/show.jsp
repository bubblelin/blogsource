...
<div id="MainArea">
	...
	<center>
		...
		<div class="ForumPageTableBorder">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tbody class="dataContainer" datakey="topicList">
					...
					<tr height="35" id="d0" class="template">
						...
						<td class="Topic">
							<s:a cssclass="Default" action="topic_topicShow?id=%{id}" namespace="/">
								${title}
							</s:a>
						</td>
						...
						<td class="ForumTopicPageDataLine">
							<ul class="ForumPageTopicUl">
								...
								<li class="CreateTime"><s:date name="lastReply.postTime" format="yyyy-MM-dd HH:mm"/></li>
							</ul>
						</td>
						<td></td>
					</tr>
			...
			<!--其他操作-->
			<!-- 分页需要的表单 -->
		<s:form id="pageForm" action="forum_forumShow" namespace="/">

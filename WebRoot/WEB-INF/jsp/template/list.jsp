...
<div id="MainArea">
    <table cellspacing="0" cellpadding="0" class="TableStyle">
		...
		<s:iterator value="templates">
			<tr class="TableDetail1 template">
					...
					<td><s:a onClick="return window.confirm('确认删除吗？')" action="template_delete?id=%{id}" namespace="/">删除</s:a>
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
			<s:a action="template_addUI" namespace="/"><img src="${pageContext.request.contextPath}/style/blue/images/button/addNew.PNG" /></s:a>
        </div>
    </div>

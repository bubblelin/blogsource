...
<body class="PageBody" style="margin: 0">
	...
	<div id="Head1">
		<div id="Logo">
            ...
            <font color="#0000CC" style="color:#F1F9FE; font-size:28px; font-family:Arial Black, Arial">YanLin's OA</font> 
        ...
        <div id="Head1Right_SystemButton">
            <a target="_parent" href="${pageContext.request.contextPath}/user_logout.do">
